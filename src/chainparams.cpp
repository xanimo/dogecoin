...
public:
    CMainParams() {
        ...
        // SegWit version-5 activation not scheduled on mainnet (requires DIP
        ...
        // Deployment of MWEB (MimbleWimble Extension Blocks)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartTime = 0; // Disabled for now
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeout = 0; // Disabled
...
public:
    CRegTestParams() {
        ...
        // Phase 0 SegWit activation via version-5 supermajority (AuxPoW-safe).
        // Small start height so functional tests can drive activation quickly;
        // the supermajority threshold/window reuse nMajorityEnforceBlockUpgrade
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeout = 999999999999ULL;
