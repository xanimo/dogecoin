/*
 * Random byte generation for Falcon-512 PQC implementation.
 * Uses /dev/urandom on Linux/Unix systems, CryptGenRandom on Windows.
 *
 * This provides a simple, self-contained random byte source suitable
