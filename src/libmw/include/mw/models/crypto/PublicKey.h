...
#ifndef MW_MODELS_CRYPTO_PUBLICKEY_H
#define MW_MODELS_CRYPTO_PUBLICKEY_H
...
public:
    ...
    using CPtr = std::shared_ptr<const PublicKey>;

    PublicKey() { memset(m_data, 0, SIZE); }
    ...
    bool operator==(const PublicKey& rhs) const { return memcmp(m_data, rhs.m_data, SIZE) == 0; }
...
#endif // MW_MODELS_CRYPTO_PUBLICKEY_H
