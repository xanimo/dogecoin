...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx)
{
    ...
    // Use BIP9 version-bits computed version; OR in the Dogecoin chain ID in bits 16-28.
    // GetChainId() now masks to (nVersion >> 16) & 0x1FFF so BIP9 bits 29-31 no longer
    // corrupt the chain ID.
