...
void CConnman::AcceptConnection(const ListenSocket& hListenSocket) {
    ...
    if (NetPermissions::HasFlag(permissionFlags, NetPermissionFlags::PF_ISIMPLICIT)) {
        ...
        if (GetBoolArg("-whitelistforcerelay", false)) NetPermissions::AddFlag(permissionFlags, PF_FORCERELAY);
        if (GetBoolArg("-whitelistrelay", false)) NetPermissions::AddFlag(permissionFlags, PF_RELAY);
    ...
    if (IsBanned(addr) && !legacyWhitelisted)
    {
