...
{
    // Set up wallet and chain with 241 blocks (1 mature block for spending).
    ...
    QCOMPARE(transactionTableModel->rowCount({}), 241);
    ...
    QCOMPARE(transactionTableModel->rowCount({}), 243);
