...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    BOOST_CHECK((ResolveIP("1.2.3.4").GetGroup() == std::vector<unsigned char>{NET_IPV4, 1, 2})); // IPv4
    BOOST_CHECK((ResolveIP("::FFFF:0:102:304").GetGroup() == std::vector<unsigned char>{NET_IPV4, 1, 2})); // RFC6145
    BOOST_CHECK((ResolveIP("64:FF9B::102:304").GetGroup() == std::vector<unsigned char>{NET_IPV4, 1, 2})); // RFC6052
    BOOST_CHECK((ResolveIP("2002:102:304:9999:9999:9999:9999:9999").GetGroup() == std::vector<unsigned char>{NET_IPV4, 1, 2})); // RFC3964
    BOOST_CHECK((ResolveIP("2001:0:9999:9999:9999:9999:FEFD:FCFB").GetGroup() == std::vector<unsigned char>{NET_IPV4, 1, 2})); // RFC4380
    BOOST_CHECK((ResolveIP("FD87:D87E:EB43:edb1:8e4:3588:e546:35ca").GetGroup() == std::vector<unsigned char>{NET_TOR, 239})); // Tor
    BOOST_CHECK((ResolveIP("2001:470:abcd:9999:9999:9999:9999:9999").GetGroup() == std::vector<unsigned char>{NET_IPV6, 32, 1, 4, 112, 175})); //he.net
    BOOST_CHECK((ResolveIP("2001:2001:9999:9999:9999:9999:9999:9999").GetGroup() == std::vector<unsigned char>{NET_IPV6, 32, 1, 32, 1})); //IPv6
