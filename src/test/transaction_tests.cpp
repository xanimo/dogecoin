...
static std::map<std::string, unsigned int> mapFlagNames = {
    ...
    {"DERSIG", (unsigned int)SCRIPT_VERIFY_DERSIG},
    ...
    {"MINIMALIF", (unsigned int)SCRIPT_VERIFY_MINIMALIF},
    {"NULLFAIL", (unsigned int)SCRIPT_VERIFY_NULLFAIL},
    {"CHECKLOCKTIMEVERIFY", (unsigned int)SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY},
    {"CHECKSEQUENCEVERIFY", (unsigned int)SCRIPT_VERIFY_CHECKSEQUENCEVERIFY},
    {"WITNESS", (unsigned int)SCRIPT_VERIFY_WITNESS},
    {"DISCOURAGE_UPGRADABLE_WITNESS_PROGRAM", (unsigned int)SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_WITNESS_PROGRAM},
    {"WITNESS_PUBKEYTYPE", (unsigned int)SCRIPT_VERIFY_WITNESS_PUBKEYTYPE},
};
