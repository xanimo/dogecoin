...
static const int MAX_BLOCKS_IN_TRANSIT_PER_PEER_IBD = 128;
...
/** Larger download window during IBD to allow fetching blocks further ahead in parallel from
 *  multiple peers, significantly improving sync throughput. */
