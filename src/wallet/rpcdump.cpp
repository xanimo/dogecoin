...
void ImportAddress(CWallet*, const CTxDestination& dest, const string& strLabel);
...
void ImportAddress(CWallet * const pwallet, const CTxDestination& dest, const string& strLabel)
{
